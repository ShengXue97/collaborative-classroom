...
const createAccounts = () => {
  const query =
    "CREATE TABLE IF NOT EXISTS accounts ( id SERIAL PRIMARY KEY, name VARCHAR(255), login VARCHAR(255), password VARCHAR(255), modules VARCHAR(255));";
